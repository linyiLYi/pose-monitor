...
class MainActivity : AppCompatActivity() {
    ...
    /** 设置一个 Debug 信息显示的 TextView */
    private lateinit var tvDebug: TextView

    /** 设置一个显示当前状态的 ImageView */
                    ...
                    CameraSource(surfaceView, object : CameraSource.CameraSourceListener {
                        ...
                        override fun onDetectedInfo(
                            ...
                            if (poseLabels != null && personScore != null && personScore > 0.3) {
                                ...
                                if (sortedLabels[0].first == "forwardhead") {
                                    crosslegCounter = 0
                                    standardCounter = 0
                                    ...
                                    /** 显示 Debug 信息 */
                                    tvScore.text = getString(R.string.tfe_pe_tv_debug, "${sortedLabels[0].first} $forwardheadCounter")
                                }
                                else if (sortedLabels[0].first == "crossleg") {
                                    ...
                                    /** 显示 Debug 信息 */
                                    tvScore.text = getString(R.string.tfe_pe_tv_debug, "${sortedLabels[0].first} $crosslegCounter")
                                }
                                else {
                                    forwardheadCounter = 0
                                    crosslegCounter = 0
...
//                                            forwardheadPlayer.stop()
                                    ...
                                    /** 显示 Debug 信息 */
                                    tvScore.text = getString(R.string.tfe_pe_tv_debug, "${sortedLabels[0].first} $standardCounter")
                                }
                                ...
                                /** 显示 Debug 信息 */
                                tvScore.text = getString(R.string.tfe_pe_tv_debug, "missing $missingCounter")
                            }
